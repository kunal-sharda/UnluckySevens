...
| UCR-005 | judgment | user request and DESIGN.md | The complete iPhone catalog reads as one cohesive product in typography, hierarchy, materials, icon language, spacing, opacity, and interaction ownership; representative iPad states remain usable | fresh catalog/contact-sheet inspection and product/UX review | report:iphone-63-capture-contact-sheet-pass-2026-08-10; artifact:`output/ui-screenshot-harness/20260812T062534Z-ipad`; artifact:`output/ui-screenshot-harness/20260812T063102Z-ipad` | blocked | iPad drawer recovery now works and Lobby, Settings/Rules/Strategy, and all 17 Tutorial screens pass. The first gameplay route exposed a real cohesion defect: Game Information centers at x=371.5 while the Trade composer centers at x=410 on the 820-point iPad surface |
...
| product-ux | yes | blocked | report:iphone-63-capture-contact-sheet-pass-2026-08-10; iPad utility/tutorial states pass, but gameplay overlay horizontal alignment fails |
